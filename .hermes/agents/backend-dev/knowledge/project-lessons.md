...
### 经验：实现代码
- project_type: wf-routing-priority-failure
- role_key: backend-dev
- tags: wf-routing-priority-failure, backend-1, backend-dev
...
### 经验：ok
- project_type: wf-bus-handoff
- role_key: backend-dev
- tags: wf-bus-handoff, backend-1, backend-dev
...
- project_type: wf-review-routing
- role_key: backend-dev
- tags: wf-review-routing, backend-1, backend-dev
...
- project_type: wf-handoff
- role_key: backend-dev
- tags: wf-handoff, backend-1, backend-dev
...
- project_type: wf-knowledge-pack
- role_key: backend-dev
- tags: wf-knowledge-pack, backend-1, backend-dev
...
### 经验：implement:实现代码
- project_type: wf-backend
- role_key: backend-dev
- tags: wf-backend, backend-1, backend-dev
...
### 经验：模拟执行: 实现代码
- project_type: wf-simulated
- role_key: backend-dev
- tags: wf-simulated, backend-1, backend-dev
...
### 经验：done
- project_type: wf-real-exec-success-shape
- role_key: backend-dev
- tags: wf-real-exec-success-shape, backend-1, backend-dev
