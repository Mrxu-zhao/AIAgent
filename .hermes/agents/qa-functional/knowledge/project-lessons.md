...
### 经验：确认闭环
- project_type: wf-missing-deliverable
- role_key: qa-functional
- tags: wf-missing-deliverable, qa-functional, qa-functional
...
### 经验：执行功能测试
- project_type: wf-quality-gate
- role_key: qa-functional
- tags: wf-quality-gate, qa-functional, qa-functional
...
- role_key: qa-functional
- tags: wf-collab, qa-functional, qa-functional
